...
class Player extends Phaser.Physics.Arcade.Sprite {
    constructor(
        ...
        //this.controls.space.setEmitOnRepeat(true);
    ...
    movement() {
        if (this.scene.controls.up.isDown) {
        //Accelerate
        ...
        else if (this.scene.controls.down.isDown) {
        //Decelerate
        this.scene.physics.velocityFromRotation(
            this.rotation,
        ...
        } else if (this.scene.controls.right.isDown) {
            //Rotate Right
            this.setRotation(this.rotation + this.rotationSpeed);
        }
    }
    ...
    shooting() {
        ...
        if (this.scene.controls.space.isDown && this.bulletTime <= this.scene.time.now) {
    ...
    shootingController() {
        //Working solution to not allowing the player to just hold the down key.
        //Later on I want to implement a recharging ammo system. But thats for a later day
        if (this.controls.space.isDown && this.bulletTime <= this.time.now) {
